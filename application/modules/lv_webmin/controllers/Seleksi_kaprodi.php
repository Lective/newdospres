...
class Seleksi_kaprodi extends CI_Controller {
	...
	function reg($nidn)
	{
		...
		if ($check == 0) {
			...
			$this->session->set_flashdata('alert', (object)array('status' => 'success', 'message' => 'Dosen telah berhasil didaftarkan pada tahun ini, silahkan cek menu calon kaprodi berprestasi'));
		} else {
