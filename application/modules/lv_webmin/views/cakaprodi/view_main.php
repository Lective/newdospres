    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">Tambah Calon Kaprodi Berprestasi</h4>
            </div>
            <form action="<?php echo site_url('webmin/cakaprodi-berprestasi/tambah') ?>" method="post" class="form-horizontal" autocomplete="off">
