    ...
    <script src="<?php echo base_url ('public/global/vendor/bootstrap-datepicker/bootstrap-datepicker.js') ?>"></script>

    <script src="<?php echo base_url ('public/global/vendor/datatables/jquery.dataTables.min.js') ?>"></script>
    <script src="<?php echo base_url ('public/global/vendor/datatables-fixedheader/dataTables.fixedHeader.js') ?>"></script>
    <script src="<?php echo base_url ('public/global/vendor/datatables-bootstrap/dataTables.bootstrap.js') ?>"></script>
    ...
    <script src="<?php echo base_url ('public/global/js/components/datatables.js') ?>"></script>
    <script src="<?php echo base_url ('public/global/js/components/bootstrap-datepicker.js') ?>"></script>
