...
INSERT INTO `dospres_formulir_kaprodi` (`id_formulir_kaprodi`, `nidn`, `nama_lengkap`, `jabatan_akademik`, `pangkat_dan_golongan`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `bidang_keahlian`, `no_hp`, `email`, `file_makalah`, `tahun`, `id_fakultas`, `id_program_studi`) VALUES
(7, 3123123, '123123', 'aaaa', 'aaaa', 'Trenggalek', '1996-03-13', 'Laki-Laki', 'asdas', '12344', 'pilusnarziz3@gmail.com', NULL, 2017, 11, 14);
...
--
ALTER TABLE `dospres_formulir_kaprodi`
  MODIFY `id_formulir_kaprodi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
